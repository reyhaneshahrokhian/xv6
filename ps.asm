...
int main(int argc, char *argv[])
{
  ...
  26:	e8 25 06 00 00       	call   650 <malloc>
      *hold = 3;
  2b:	83 c4 10             	add    $0x10,%esp
  2e:	c7 00 03 00 00 00    	movl   $0x3,(%eax)
      {
         //do nothing
      }     
   }  
   int pid2 = fork();
  34:	e8 82 02 00 00       	call   2bb <fork>
   if(pid2 > 0){
  39:	85 c0                	test   %eax,%eax
  3b:	7f 0e                	jg     4b <main+0x4b>
      int *hold2 =(int*)malloc(50*sizeof(int));
      *hold2 =3;
   }
   else if (pid2==0)
  3d:	74 0a                	je     49 <main+0x49>
      while (true)
      {
         //do nothing
      }     
   ...
   proc_dump();
  3f:	e8 1f 03 00 00       	call   363 <proc_dump>
   exit();
  44:	e8 7a 02 00 00       	call   2c3 <exit>
      while (true)
  49:	eb fe                	jmp    49 <main+0x49>
      int *hold2 =(int*)malloc(50*sizeof(int));
  4b:	83 ec 0c             	sub    $0xc,%esp
  4e:	68 c8 00 00 00       	push   $0xc8
  53:	e8 f8 05 00 00       	call   650 <malloc>
      *hold2 =3;
  58:	83 c4 10             	add    $0x10,%esp
  5b:	c7 00 03 00 00 00    	movl   $0x3,(%eax)
  61:	eb dc                	jmp    3f <main+0x3f>
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
